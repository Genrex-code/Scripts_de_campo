...
Modos:
    - Full: Panel completo con gráficas (requiere rich + plotext)
    - Simple: Modo texto básico (fallback automático)
"""
...
# ============================================================================
# CLASES BASE (definidas localmente para evitar dependencias circulares)
# ============================================================================
...
class SignalObserver(ABC):
    ...
    def update(self, refined_data: List[Dict[str, Any]], summary: Dict[str, Any]) -> None:
        """Método llamado cuando hay nuevos datos"""
        pass
...
class SimpleTUIObserver(SignalObserver):
    ...
    def __init__(self, refresh_rate: float = 1.0):
        # CORRECCIÓN: Usar ObserverPriority.LOW con mayúscula
